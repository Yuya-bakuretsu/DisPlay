...
const createGroove = function () {
  ...
  var pathBackground = d3.select("g").append('path')
...
const createClock = function () {
  var circle = d3.select("g").append('circle')
    .attr('r', '63.5')
    .style('fill', 'url(#lightGradient)');

  var centerCircle = d3.select("g").append('circle')
    .attr('r', '7.5')
    .style('fill', '#1f242a');
  ...
  var pointer = d3.select("g").append('rect')
    .attr('width', 6)
    .attr('height', 45)
    .attr('rx', 2.5)
    .attr('ry', 2.5)
  ...
  var outerEdgepath = d3.select("g").append('path')
